...
export const guideContent: { key: string; title: string; text: string }[] = [
  { key: 'dashboard', title: 'Bosh sahifa', text: 'Bosh sahifa omborning joriy holatini bir qarashda ko‘rsatadi. Bu yerda inventar qiymati, kirim-chiqim va kam qoldiq ko‘rsatkichlarini ko‘rasiz. Tezkor amallar orqali mahsulot, kirim, chiqim yoki ko‘chirish hujjatini darhol yarating.' },
  { key: 'products', title: 'Mahsulotlar', text: 'Mahsulotlar bo‘limida katalogdagi barcha mahsulotlar saqlanadi. Yangi mahsulot qo‘shishda turi, kategoriya, ombor, birlik, narx va qoldiqni kiriting. Qidiruv orqali nom, ID yoki shtrix kod bo‘yicha kerakli mahsulotni topib, tahrirlashingiz mumkin.' },
  { key: 'ready-products', title: 'Tayyor mahsulotlar', text: 'Tayyor mahsulotlar sotuvga tayyor bo‘lgan mahsulotlarni alohida ko‘rsatadi. Ro‘yxatni qoldiq, narx va ombor bo‘yicha ko‘zdan kechiring. Mahsulot kartasidan batafsil ma’lumot va shtrix kodni yuklab olish mumkin.' },
  { key: 'raw-products', title: 'Xom mahsulotlar', text: 'Xom mahsulotlar ishlab chiqarishda ishlatiladigan materiallarni boshqarish uchun kerak. Ushbu bo‘limda ularning qoldig‘i va minimal chegarasini kuzating. Kamaygan materiallarni yangi kirim bilan vaqtida to‘ldiring.' },
  { key: 'semi-products', title: 'Yarim tayyor mahsulotlar', text: 'Yarim tayyor mahsulotlar ishlab chiqarish jarayonining oraliq natijalarini saqlaydi. Ularni alohida ko‘rish hisob va rejalashtirishni osonlashtiradi. Har bir yozuvdan qoldiq va joylashuvni tekshiring.' },
  { key: 'inventory', title: 'Ombordagi mahsulotlar', text: 'Ombordagi mahsulotlar barcha omborlardagi mavjud qoldiqni ko‘rsatadi. Jadvaldan mahsulot nomi, ombori, miqdori va holatini solishtiring. Kam qoldiq belgisi qayta buyurtma berish kerakligini bildiradi.' },
  { key: 'purchases', title: 'Kirim qilingan mahsulotlar', text: 'Kirim bo‘limida yetkazib beruvchidan kelgan mahsulotlar rasmiylashtiriladi. Mahsulotni shtrix kod bilan skanerlang yoki ro‘yxatdan tanlang, miqdor va narxni kiriting. Saqlangandan keyin qoldiq oshadi va operatsiya tarixga yoziladi.' },
  { key: 'sales', title: 'Chiqim qilingan mahsulotlar', text: 'Chiqim bo‘limi mijozga berilgan yoki sotilgan mahsulotlarni qayd etadi. Mahsulot, ombor va miqdorni tanlab, hujjatni saqlang. Tizim qoldiqni kamaytiradi va chiqim summasini hisobotlarga qo‘shadi.' },
  { key: 'available', title: 'Sotuvda mavjud mahsulotlar', text: 'Bu bo‘lim qoldig‘i noldan katta bo‘lgan mahsulotlarni ajratib beradi. Sotuvga tayyor assortimentni tezda ko‘rib, kerakli mahsulotni toping. Qoldiq tugasa mahsulot bu ro‘yxatdan avtomatik chiqadi.' },
  { key: 'sold', title: 'Sotilgan mahsulotlar', text: 'Sotilgan mahsulotlar chiqim hujjatlari asosida savdoga ketgan mahsulotlarni ko‘rsatadi. Bu ro‘yxat orqali mijoz buyurtmalari va summalarni tekshiring. Ma’lumotlar analitika va savdo hisobotida ham aks etadi.' },
  { key: 'transfers', title: 'Ko‘chirishlar', text: 'Ko‘chirish omborlar o‘rtasida mahsulot joyini almashtirish uchun ishlatiladi. Qaysi ombordan va qaysi omborga ko‘chirishni tanlang. Ko‘chirilgan miqdor bir ombordan kamayib, ikkinchisiga qo‘shiladi.' },
  { key: 'writeoffs', title: 'Hisobdan chiqarish', text: 'Hisobdan chiqarish buzilgan, yo‘qolgan yoki foydalanib bo‘lmaydigan mahsulotlarni qayd etadi. Sababni yozib, mahsulot va miqdorni ko‘rsating. Saqlangandan so‘ng qoldiq kamayadi va operatsiya tarixda qoladi.' },
  { key: 'suppliers', title: 'Yetkazib beruvchilar', text: 'Yetkazib beruvchilar bo‘limida mahsulot olib keladigan hamkorlar saqlanadi. Yangi hamkor nomi va aloqa ma’lumotlarini kiriting. Kirim yaratishda shu ro‘yxatdan yetkazib beruvchini tanlash mumkin.' },
  { key: 'analytics', title: 'Analitika', text: 'Analitika mahsulot, kategoriya, ombor va operatsiyalar bo‘yicha umumiy ko‘rinish beradi. Kartalar asosiy sonlarni, grafiklar esa taqsimot va dinamikani ko‘rsatadi. TOP-5 jadvali eng ko‘p harakatlangan mahsulotlarni aniqlashga yordam beradi.' },
  { key: 'reports', title: 'Hisobotlar', text: 'Hisobotlar bo‘limida ombor qoldig‘i, kirim-chiqim, savdo va inventarizatsiya ma’lumotlarini tayyorlang. Sana va ombor filtrlari bilan natijani toraytiring. Tayyor jadvalni CSV shaklida yuklab, boshqa dasturlarda ishlatishingiz mumkin.' },
  { key: 'expiry', title: 'Yaroqlilik muddati', text: 'Yaroqlilik muddati bo‘limida partiyalar va ularning tugash sanasi nazorat qilinadi. Mahsulot, ombor, partiya, miqdor va sanani kiriting. Qolgan kunlar kamayganda mahsulotni o‘z vaqtida ishlatish yoki chiqarishni rejalashtiring.' },
  { key: 'settings', title: 'Tizim sozlamalari', text: 'Tizim sozlamalarida kompaniya nomi, tizim nomi va valyuta belgisi kabi umumiy qiymatlar boshqariladi. Maydonlarni yangilang va Saqlash tugmasini bosing. O‘zgarishlar tizimning tegishli joylarida ishlatiladi.' },
  { key: 'users', title: 'Foydalanuvchilar', text: 'Foydalanuvchilar bo‘limi tizimga kiradigan xodimlarni boshqaradi. Administrator foydalanuvchi rolini almashtirishi yoki kirishini bloklashi mumkin. Faqat vazifaga mos huquq berish ma’lumotlar xavfsizligini yaxshilaydi.' },
  { key: 'warehouses', title: 'Omborlar', text: 'Omborlar bo‘limida saqlash joylari va ularning kodlari boshqariladi. Har bir omborni noyob kod bilan qo‘shing yoki tahrirlang. Mahsulot va operatsiya kiritishda shu omborlardan biri tanlanadi.' },
  { key: 'categories', title: 'Kategoriyalar', text: 'Kategoriyalar mahsulotlarni tartibli guruhlarga ajratish uchun kerak. Yangi kategoriya qo‘shib, mahsulot kiritishda uni tanlang. Tahlil va qidiruvda kategoriyalar bo‘yicha taqsimot aniqroq ko‘rinadi.' },
]
